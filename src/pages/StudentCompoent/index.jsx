...
const INITIAL_STATE = {
    ...
    titleTable: 'StudentCompoent', // Tiêu đề của bảng
    ...
    modalProps: {
        ...
        action: '',
        formFieldsProp: [
            {name: 'student_name', type: 'text', label: 'Student Name', placeholder: 'Enter the student name'},
            {name: 'email', type: 'text', label: 'Duration', placeholder: 'Enter email'},
            {name: 'call_number', type: 'text', label: 'Duration', placeholder: 'Enter call number'},
            {
                name: 'status',
                type: 'select',
                label: 'Status',
...
// Các cột của bảng
const COLUMNS = ['ID', 'Họ tên', 'Email', 'Số điện thoại', 'Trạng thái', ''];
...
//Search
    ...
    useEffect(() => {
        ...
        console.log('Render StudentCompoent');
    }, [fetchData, currentPage]);
